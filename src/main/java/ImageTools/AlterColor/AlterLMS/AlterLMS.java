...
public class AlterLMS extends AlterColor {
    protected double KLM =  1.051182996;  // M coefficient to calculate L and simulate protanopia (1.05118294)
    protected double KLS =  -0.05116099621;  // S coefficient to calculate L and simulate protanopia (-0.05116099)
    protected double KML =  0.95133125;  // L coefficient to calculate M and simulate deuteranopia (0.95133125)
    protected double KMS =  0.04866874;  // S coefficient to calculate M and simulate deuteranopia (0.04866874)
